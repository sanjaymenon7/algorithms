...
import java.util.Scanner;
 // Code modified from http://www.sanfoundry.com/java-program-find-mst-using-prims-algorithm/
public class Prims
{
    ...
    public void printMST(int caseNo, int numberOfTestcases)
    {
